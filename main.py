...
class AfApp:
    def __init__(self, root):
        ...
        label = tk.Label(root, text="Ingresa la cadena 'VARC'", font=("Arial", 16))
        label.pack(pady=10)
    ...
    def handle_input_change(self, *args):
        ...
        if len(value) <= 4 and all(char in self.Letters for char in value) and value.startswith('V'):
